    ...
    <div class="add_user_content">
      <el-form :model="ruleForm" :rules="rules" label-width="200px" size="small" ref="accountForm">
        ...
        <el-form-item :label="$t('newUser.ExpireDate')">
          <el-row>
            <el-col>
              ...
              <el-input v-model.trim="ruleForm.month" class="input_width_250px">
              </el-input>
            </el-col>
            <el-col class="date_select_day">
              <el-radio v-model="timeSelect" label="2">{{$t('newUser.SetDate')}}</el-radio>
              <el-date-picker v-model="ruleForm.date" type="date" value-format="timestamp" format="dd-MMM-yyyy" class="input_width_250px">
              </el-date-picker>
            </el-col>
          </el-row>
        </el-form-item>
        ...
        <el-form-item class="btn_form_item">
          <el-button type="primary" @click="createAccount('accountForm')">{{$t('newUser.CreateAccount')}}</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
