  ...
  <div class="email_wrapper">
    ...
    <div class="email_content">
      <el-form class="demo-form-inline form" :inline="true" label-position="left" size="small">
        <el-alert style="padding:8px 0;margin-bottom:20px" :title="$t('email.unitDetailsEmailTemplate')" type="info" :closable="false"></el-alert>
        <el-row>
        ...
        <el-row>
          <el-col :span="12" class="col_padding_x">
            <el-form-item :label="$t('email.welcomeMessage')">
              <editor editorId="unitEdit" :value="unitEdit" :setting="editorSetting" @show="editors" @on-upload-success="onEditorUploadComplete"></editor>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12" class="col_padding_x">
            <el-form-item :label="$t('email.emailTemplate')">
              <editor editorId="unitEdit1" :value="unitEdit1" :setting="editorSetting" @show="editors" @on-upload-success="onEditorUploadComplete"></editor>
            </el-form-item>
          </el-col>
        </el-row>
        <el-alert style="padding:8px 0;margin-bottom:20px" :title="$t('email.PropertyDetailsEmailTemplate')" type="info" :closable="false"></el-alert>
        <el-row>
          <el-col :span="12" class="col_padding_x">
            <el-form-item :label="$t('email.subject')">
        ...
        <el-row>
          <el-col :span="12" class="col_padding_x">
            <el-form-item :label="$t('email.welcomeMessage')">
              <editor editorId="propertyEdit" :value="propertyEdit" :setting="editorSetting" @show="editors" @on-upload-success="onEditorUploadComplete"></editor>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12" class="col_padding_x">
            <el-form-item :label="$t('email.emailTemplate')">
              <editor editorId="propertyEdit1" :value="propertyEdit1" :setting="editorSetting" @show="editors" @on-upload-success="onEditorUploadComplete"></editor>
            </el-form-item>
          </el-col>
        </el-row>
...
export default {
  ...
  methods: {
    getTemplate() {
      this.$Geting(this.$api.queryProjectTemplate, { projectId: this.id }).then(
        res => {
          if (res.code == 0) {
