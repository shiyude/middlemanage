          ...
          <el-row>
            <el-col :span="12">
              <el-form-item :label="$t('settings.InterestExpirationTime')">
                ...
                <el-date-picker class="width_300px" v-model.trim="settingForm.interestExpirationTime" type="datetime" value-format="timestamp"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="12">
          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item :label="$t('settings.NumberofDaysforReminder')">
                <el-input class="width_300px" v-model.trim="notificationSet.preReservedDays" :maxlength="5"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item :label="$t('settings.NumberofDaysforReminder')">
                <el-input class="width_300px" v-model.trim="notificationSet.reservationDays" :maxlength="5"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item :label="$t('settings.NumberofDaysforReminder')">
                <el-input class="width_300px" v-model.trim="notificationSet.sendPendingSpaSignDays" :maxlength="5"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item :label="$t('settings.NumberofDaysforReminder')">
                <el-input class="width_300px" v-model.trim="notificationSet.pendingSpaStampDays" :maxlength="5"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item :label="$t('settings.NumberofDaysforReminder')">
                <el-input class="width_300px" v-model.trim="notificationSet.soldDateDays" :maxlength="5"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </div>
      ...
      <div class="div_padding_x">
        <el-row class="row_header">
          ...
          <el-col :span="12" class="col_button">
            <el-button size="mini" @click="add" :disabled="tableDataInit!==-1">{{$t('settings.addOtherSellingEntity')}}
            </el-button>
            <el-button size="mini" @click="refresh">{{$t('settings.refresh')}}
            </el-button>
          </el-col>
        </el-row>
...
export default {
  ...
  methods: {
    ...
    update() {
      console.log(this.checkedBrokes);
      this.$Posting(this.$api.saveProjectCompany, {
        projectId: this.id,
        companyIds: this.checkedBrokes.join()
      }).then(res => {
        if (res.code == 0) {
          this.$notify.success({
            title: this.$t("alert.alert_success_title"),
    ...
    add() {
      let brokeList = this.brokeList;
      let brokeOfProjectList = this.brokeOfProjectList;
      if (brokeList.length && brokeOfProjectList.length) {
        for (let i = 0; i < brokeList.length; i++) {
          for (let j = 0; j < brokeOfProjectList.length; j++) {
            if (brokeList[i].companyName == brokeOfProjectList[j].companyName) {
              this.checkedBrokes.push(brokeList[i].companyId);
            }
          }
        }
      }
