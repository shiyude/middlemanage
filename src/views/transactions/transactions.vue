  ...
  <div class="transactions_list_wrapper">
    ...
    <div class="transactions_list_table transactions_section">
      <el-table :data="transactionsList" border style="width: 100%" :header-cell-style="{'background':'#f5f7fa'}" size="mini">
        ...
        <el-table-column :label="$t('transactions.SalesRep')" prop="salesRep">
        </el-table-column>
        ...
        <!-- <el-table-column :label="$t('transactions.Download')">
          <template slot-scope="scope">
            <el-button size="mini" plain>{{$t('transactions.Download')}}</el-button>
          </template>
        </el-table-column> -->
        ...
        <el-form :inline="true" size="mini" label-width="180px">
          ...
          <template v-if="buyerList.length">
            <el-row v-for="(item,k) in buyerList" :key="k">
              <el-form-item :label="$t('transactions.Buyer')+item.isMain+$t('transactions.Name')">
                <el-input v-model.trim="item.buyerName"></el-input>
              </el-form-item>
              <el-form-item :label="$t('transactions.Buyer')+item.isMain+$t('transactions.ID')">
                <el-input v-model.trim="item.buyerId" readonly></el-input>
              </el-form-item>
              <el-form-item :label="$t('transactions.Buyer')+item.isMain+$t('transactions.Email')">
                <el-input v-model.trim="item.buyerEmail"></el-input>
              </el-form-item>
              <el-form-item :label="$t('transactions.Buyer')+item.isMain+$t('transactions.Mobile')">
