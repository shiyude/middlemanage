<template>
  <div class="notification_wrapper">
          ...
          <div class="history_message">
            ...
            <div class="announcements" v-show="secondNavIndex == 1">
              ...
              <div class="page_section" v-if="announcementPage.count">
                <el-pagination background small @size-change="handleAnnounceSizeChange" @current-change="handleAnnounceCurrentChange" :current-page.sync="announcementPage.currentPage" :page-sizes="[5,10,30,50,100]" :page-size="announcementPage.pageSize" layout="prev, pager, next,sizes,total" :total="announcementPage.count">
                </el-pagination>
              </div>
            </div>
            <div class="transactions" v-show="secondNavIndex == 2">
              ...
              <div class="page_section" v-if="transactionPage.count">
                <el-pagination background small @size-change="handleTransactionSizeChange" @current-change="handleTransactionCurrentChange" :current-page.sync="transactionPage.currentPage" :page-sizes="[5,10,30,50,100]" :page-size="transactionPage.pageSize" layout="prev, pager, next,sizes,total" :total="transactionPage.count">
                </el-pagination>
              </div>
            </div>
          </div>
    ...
    <el-dialog :title="$t('notification.Message')" :visible.sync="dialogVisible" width="900px" class="message_dialog">
      <div class="base64_content" v-if="base64Content">{{base64Content}}</div>
